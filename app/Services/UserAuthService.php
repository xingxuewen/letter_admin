...
class UserAuthService
{
    ...
    {
        return UserAuthModel::create($data);
    }
    /**
     * 查询权限信息
     * @param array $data
    ...
    {
        $result = UserAuthModel::where('id', '=', $id)->first();
        return $result;
    }
    ...
    {
        return UserAuthModel::where('id', '=', $id)
            ->update($updateData);
    }
    ...
    {
        return UserAuthModel::destroy($id);
    }
