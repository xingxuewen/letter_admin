...
class LoginController extends BaseController
{
    ...
    */
    ...
    protected function attemptLogin(Request $request)
    {
        ...
        if ($usernameLogin) {
            return $this->successRouteTo('admin/index', trans('common.success'));
        }
        // 验证手机号登录方式
        ...
        if ($mobileLogin) {
            return $this->errorBackTo(['error' => trans('common.user_error')]);
        }
        // 验证邮箱登录方式
...
//            return true;
//        }
        return $this->successRouteTo('admin/login', trans('common.user_error'));
    }
