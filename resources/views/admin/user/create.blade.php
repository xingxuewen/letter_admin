...
<article class="page-container">
    <form action="" method="post" class="form form-horizontal" id="add-role-form">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="radio-box" style="padding-left: 0px;">
                    <input type="radio" id="status-1" name="sex" value="1" @if(!empty($result->sex) && $result->sex == 1) checked @endif>
                    <label for="status-1">男</label>
                </div>
                <div class="radio-box" style="padding-left: 0px;">
                    <input type="radio" id="status-2" name="sex" value="2" @if(isset($result->sex) && $result->sex == 2) checked @endif>
