        ...
        <div class="text-l">
            <form method="GET" action="{{route('user.lists')}}">
                <p style="display: inline-block;" class="search_p">
                    <span>位置</span>
                    <input type="text" class="input-text radius" value="{{$requestData['name'] ?? ''}} " style="width:200px" placeholder="banner位置" id="" name="name">
                </p>
                <p style="display: inline-block;" class="search_p">
            ...
            <tbody>
                ...
                <tr class="text-c">
                    ...
                    <td>
                        ...
                        @elseif($row->ad_num == 3)
                            <span class="label label-success">laning</span>
                        @else
